...
export const miniprogramSpecificationTableFormPath = `${skuFormPath}.miniprogram.specification.specificationTable`;

export const useMiniprogramSchema = (formActions: IFormAsyncActions) => {
  const innerHandleBatchSetting = useCallback((columnInputValues, selectedRowIndexs) => {
    handleBatchSetting({
      formActions,
      specificationTableFormPath: miniprogramSpecificationTableFormPath,
      columnInputValues,
      selectedRowIndexs,
    });
  }, []);
