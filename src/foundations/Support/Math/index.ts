...
export class MathCalcul {
  ...
  plus(value: string | number) {
    this.calcInstance = this.calcInstance.plus(value);
  ...
  minus(value: string | number) {
    this.calcInstance = this.calcInstance.minus(value);
  ...
  multipliedBy(value: string | number) {
    this.calcInstance = this.calcInstance.multipliedBy(value);
  ...
  dividedBy(value: string | number) {
    this.calcInstance = this.calcInstance.dividedBy(value);
